...
public class Plutowarrior extends Monster implements Thing
{
	private Image img;
	...
	public Plutowarrior()
	{
		super("Plutowarrior",new Position(0,0),45,75);
	}
    public Plutowarrior(String n,Position p,int de,int da)
    {
    	super(n,p,850,900);
    	currentHealth = 2000;
    	maxHealth = 2000;

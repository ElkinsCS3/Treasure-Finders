...
public class Animalmaskwarrior extends Monster implements Thing
{
	private Image img;
	private boolean imgFound;

	public Animalmaskwarrior()
	{
		super("Animalmaskman",new Position(0,0),45,75);
	}
    public Animalmaskwarrior(String n,Position p,int de,int da)
    {
    	super(n,p,de,da);
    	currentHealth = 900;
    	maxHealth = 900;

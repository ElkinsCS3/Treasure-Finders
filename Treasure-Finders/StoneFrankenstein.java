...
public class StoneFrankenstein extends Monster implements Thing
{
	private Image img;
	private boolean imgFound;

	public StoneFrankenstein()
	{
		super("StoneFrankenstein",new Position(0,0),65,115);
	}
    public StoneFrankenstein(String n,Position p,int de,int da)
    {
    	super(n,p,de,da);
    	currentHealth = 500;
    	maxHealth = 500;

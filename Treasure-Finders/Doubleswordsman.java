...
public class Doubleswordsman extends Monster implements Thing
{
	private Image img;
	private boolean imgFound;

	public Doubleswordsman()
	{
		super("Doubleswordsman",new Position(0,0),45,75);
	}
    public Doubleswordsman(String n,Position p,int de,int da)
    {
    	super(n,p,de,da);
    	currentHealth = 1200;
    	maxHealth = 1200;

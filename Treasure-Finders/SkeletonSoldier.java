...
public class SkeletonSoldier extends Monster implements Thing
{
	private Image img;
	...
	{
		super("SkeletonSoldier",new Position(0,0),20,40);
	}
    public SkeletonSoldier(String n,Position p,int de,int da)
    {
    	super(n,p,de,da);
    	currentHealth = 150;
    	maxHealth = 150;

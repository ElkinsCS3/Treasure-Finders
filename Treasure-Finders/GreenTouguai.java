...
public class GreenTouguai extends Monster implements Thing
{
	private Image img;
	...
	public GreenTouguai()
	{
		super("GreenTouguai",new Position(0,0),1,20);
	}
    public GreenTouguai(String n,Position p,int de,int da)
    {
    	super(n,p,de,da);
    	currentHealth = 50;
    	maxHealth = 50;

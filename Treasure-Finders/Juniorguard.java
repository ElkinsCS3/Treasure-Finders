...
public class Juniorguard extends Monster implements Thing
{
	private Image img;
	...
	public Juniorguard()
	{
		super("Juniorguard",new Position(0,0),90,150);
	}
    public Juniorguard(String n,Position p,int de,int da)
    {
    	super(n,p,de,da);
    	currentHealth = 450;
    	maxHealth = 450;

...
public class WhiteKnight extends Monster implements Thing
{
	private Image img;
	...
	public WhiteKnight()
	{
		super("WhiteKnight",new Position(0,0),30,65);
	}
    public WhiteKnight(String n,Position p,int de,int da)
    {
    	super(n,p,de,da);
    	currentHealth = 1300;
    	maxHealth = 1300;
    ...
    {
    		window.setColor(Color.BLUE);
    		window.fillOval(x+8*scale/45, y+11*scale/45, scale-16*scale/45, scale-16*scale/45);file:
    		window.setColor(Color.BLACK);
